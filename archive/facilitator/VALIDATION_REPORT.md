...
- Moved to the [`jd-ctf-environment`](https://github.com/jdtherobot/jd-ctf-environment) repo
  (its `warehouse-game/` directory) and validated there.
- Historical result (pre-split): 27-assertion headless-Chrome test passed; fully self-contained.
...
- Moved to the [`jd-ctf-environment`](https://github.com/jdtherobot/jd-ctf-environment) repo
  and validated there.
- Historical result (pre-split): i386 toolchain proof PASS — solved C2 and C4 inside a real
  32-bit container.
...
- Lab hosting documentation moved with the lab to the
